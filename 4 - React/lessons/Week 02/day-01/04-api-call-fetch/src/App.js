    ...
    () => {
      ...
      if (selectedOrg) {
        ...
        const fetchData = async () => {
          // use the Web API of fetch to make a GET request to an URL for the value of the selectedOrg
          const response = await fetch(
            `https://api.github.com/orgs/${selectedOrg}/repos`
          );

          // execute the json method to retrieve the data from the response
